...
let builtInFuns = M.add_list
  [("ext_floor", { arg_regs = ["$f2"]; ret_reg = "$f1"; reg_ra = "$ra"; use_regs = S.of_list ["$f1"; "$f2"; "$f3"]; need_ra = true });
   ...
   ("ext_atan", { arg_regs = ["$f2"]; ret_reg = "$f1"; reg_ra = "$ra"; use_regs = S.of_list ["$i1"; "$i2"; "$f1"; "$f2"; "$f3"; "$f4"; "$f5"]; need_ra = true });
   ("ext_sin", { arg_regs = ["$f2"]; ret_reg = "$f1"; reg_ra = "$ra"; use_regs = S.of_list ["$i1"; "$i2"; "$f1"; "$f2"; "$f3"; "$f4"; "$f5"; "$f6"]; need_ra = true });
   ("ext_cos", { arg_regs = ["$f2"]; ret_reg = "$f1"; reg_ra = "$ra"; use_regs = S.of_list ["$i1"; "$i2"; "$f1"; "$f2"; "$f3"; "$f4"; "$f5"; "$f6"]; need_ra = true });
  ] M.empty
